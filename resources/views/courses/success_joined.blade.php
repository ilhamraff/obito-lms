...
@section('title', 'Success Joined - Obito LMS')
    ...
    <div class="relative flex justify-center">
        ...
        <main
            ...
            <img src="{{ asset('assets/images/icons/raising-hands.png') }}" alt="icon"
                class="mx-auto size-[60px] shrink-0" />
            <div class="mx-auto flex w-[500px] flex-col items-center gap-[10px]">
                <h1 class="text-center text-[28px] font-bold leading-[42px]">Welcome to Class,<br>Upgrade Your New Skills
                </h1>
                <p class="text-obito-text-secondary text-center leading-[28px]">Mari kita belajar meningkatkan skills
